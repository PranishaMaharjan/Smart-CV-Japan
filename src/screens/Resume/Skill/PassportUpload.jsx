...
import { addOrUpdatePassportFiles } from "../../../redux/slices/resumeSlice";
...
const PassportUpload = () => {
  ...
  const onDrop = (acceptedFiles, fileRejections) => {
    ...
    dispatch(addOrUpdatePassportFiles(newFiles));
  ...
  return (
    <div className="resume-board-block-parent">
            ...
            <div className="resume-subttl">
              <p className="resume-subttl-text">
                <img
                  ...
                  alt="info icon"
                />
                Upload your original passport. Only JPG, PDF or DOC files
                allowed. Max 5MB per file, 10 files max.
              </p>
            </div>
