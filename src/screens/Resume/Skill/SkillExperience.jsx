    ...
    <div className="resume-board-block resume-block-skill">
      <div className="resume-block-content">
        <div className="resume-block-container">
          <p className="resume-block-lead">Skill & Experience Certification</p>
          <hr />
          ...
          <div className="resume-subttl">
            <p className="resume-subttl-text">
              <img
                ...
                alt="info icon"
              />
              Upload your original Experience and skill certificates. Incomplete
              or incorrect info may cause delays. You can upload multiple
              certificate copies.
            </p>
          </div>
